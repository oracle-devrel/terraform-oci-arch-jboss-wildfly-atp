...
curl -LO -H 'Cookie: oraclelicense=accept-securebackup-cookie' -O https://download.oracle.com/otn-pub/otn_software/jdbc/1914/${JDBC_VERSION}.tar.gz
...
mv /home/opc/module.xml ${ORACLE_JDBC_MODULE_DIR}
